...
- ![Formula](https://latex.codecogs.com/svg.image?&space;P(no|meio)=\frac{P(no\cap&space;meio)}{P(no))}\Leftrightarrow\frac{\frac{3}{11}}{\frac{3}{11}}\Leftrightarrow&space;1\Leftrightarrow&space;100%)
